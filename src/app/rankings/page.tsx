...
export default function RankingsPage() {
  ...
  const tiers = [
    ...
    { name: 'MIDDLE PACK', range: [13, 20], color: 'bg-gray-400', textColor: 'text-gray-600', bgColor: 'bg-gray-50', borderColor: 'border-gray-200' },
    { name: 'REBUILDING', range: [21, 32], color: 'bg-red-400', textColor: 'text-red-600', bgColor: 'bg-red-50', borderColor: 'border-red-200' },
  ];

  const getTier = (rank: number) => tiers.find(t => rank >= t.range[0] && rank <= t.range[1]);
