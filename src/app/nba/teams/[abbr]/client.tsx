...
export default function NBATeamClient() {
  const params = useParams();
  const rawAbbr = params.abbr as string;
  const abbr = rawAbbr.toUpperCase();
  const teamName = NBA_TEAMS[abbr] || abbr;
  ...
  if (notFound) {
    return (
      <div className="text-center py-16">
        ...
        <Link href="/nba/rankings" className="text-orange-500 hover:text-orange-600 font-medium">
          ← View all teams
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-sm text-gray-500">
        <Link href="/nba/rankings" className="hover:text-orange-500">Rankings</Link>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-2 text-sm">
              <span className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold ${
                powerRank <= 3 ? 'bg-orange-500 text-white' :
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            {upcomingGames.map(game => {
              ...
              return (
                <div key={game.id} className="flex items-center justify-between p-4 bg-orange-50 rounded-lg">
