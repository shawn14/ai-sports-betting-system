...
export default function NBARankingsPage() {
  ...
  // Define tiers for NBA (30 teams)
  const tiers = [
    { name: 'ELITE', range: [1, 5], color: 'bg-green-600', textColor: 'text-green-700', bgColor: 'bg-green-50', borderColor: 'border-green-200' },
    { name: 'CONTENDERS', range: [6, 12], color: 'bg-orange-500', textColor: 'text-orange-700', bgColor: 'bg-orange-50', borderColor: 'border-orange-200' },
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between border-b border-gray-200 pb-3">
        <div className="flex items-center gap-3">
          <h1 className="text-xl font-bold text-gray-900">NBA Power Rankings</h1>
                      ...
                      <tr key={team.id} className="hover:bg-gray-50 transition-colors cursor-pointer">
                        ...
                        <td className="px-4 py-3">
                          <Link href={`/nba/teams/${team.abbreviation.toLowerCase()}`} className="flex items-center gap-3">
                            ...
                            <div>
                              <span className="font-bold text-gray-900 hover:text-orange-500">{team.abbreviation}</span>
