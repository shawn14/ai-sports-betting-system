      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="bg-white border-b border-gray-200 pb-4 mb-4">
          ...
          <p className="text-sm text-gray-600">
            The Matrix model is a Team Strength Rating (TSR) system that analyzes six critical factors to predict NFL game outcomes with <strong>59.8% accuracy</strong> and an average spread error of <strong>±11.0 points</strong>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6 bg-white border border-gray-200 rounded p-4">
          <div className="text-center border-r border-gray-200">
            <div className="text-3xl font-bold text-gray-900">59.8%</div>
            <div className="text-gray-600 text-xs">Winner Accuracy</div>
          </div>
          <div className="text-center border-r border-gray-200">
            <div className="text-3xl font-bold text-gray-900">±11.0</div>
