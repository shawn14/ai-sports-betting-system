        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-4 sm:p-6 text-white">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-red-100 text-sm">{recentResults.length} games analyzed</p>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold font-mono">{recentATS.wins}-{recentATS.losses}</div>
                <div className="text-red-200 text-xs font-medium">ATS RECORD</div>
              </div>
              {recentATS.wins + recentATS.losses > 0 && (
                <div className="text-center">
                  ...
                  <div className="text-red-200 text-xs font-medium">WIN RATE</div>
                </div>
              )}
            </div>
          </div>
