        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded px-3 py-1 mb-6">
              ...
              <span className="text-xs text-green-700 font-semibold">61.8% Win Rate • 191 Games Backtested</span>
            </div>
      ...
      <section className="py-8 bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-1">61.8%</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-1">191</div>
